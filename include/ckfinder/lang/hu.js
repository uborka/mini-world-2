...
CKFinder.lang['hu'] =
{
	...
	common :
	{
		...
		ok				: 'OK', // MISSING
		cancel			: 'Mégsem', // MISSING
		confirmationTitle	: 'Jóváhagyás', // MISSING
		messageTitle	: 'Információ', // MISSING
		inputTitle		: 'Kérdés', // MISSING
		undo			: 'Visszavonás', // MISSING
		redo			: 'Redo', // MISSING
		skip			: 'Átugrás', // MISSING
		skipAll			: 'Minden átugrása', // MISSING
		makeDecision	: 'What action should be taken?', // MISSING
		rememberDecision: 'Emlékezzen a döngésemre' // MISSING
	},
	...
	FilesLoading	: 'Betöltés...', // MISSING
	FilesEmpty		: 'Üres mappa', // MISSING
	FilesMoved		: 'File %1 moved into %2:%3', // MISSING
	FilesCopied		: 'File %1 copied into %2:%3', // MISSING

	// Basket
	BasketFolder		: 'Kosár', // MISSING
	BasketClear			: 'Kosár kiürítése', // MISSING
	...
	// Dialogs
	RenameDlgTitle		: 'Átnevezés', // MISSING
	NewNameDlgTitle		: 'Új név', // MISSING
	FileExistsDlgTitle	: 'A fájl már létezik', // MISSING
	SysErrorDlgTitle : 'Rendszer hiba', // MISSING

	FileOverwrite	: 'Felülírás', // MISSING
	FileAutorename	: 'Automatikus átnevezés', // MISSING
