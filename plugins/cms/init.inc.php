...
// Az AJAX funkciók beállítása

Core::$PLUGINS['moduls']['cmsautocomplete'] = "CmsAjax::modul_cmsautocomplete";
Core::$PLUGINS['moduls']['cmsclearapc'] = "CmsAjax::modul_cmsclearapc";
// Az utófeldolgozás funkciók bővítése
Core::insert_postfunction("core_set_content","CmsAjax","after_core_set_content");
?>
