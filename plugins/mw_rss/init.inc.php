...
Core::$PLUGINS['moduls']['mw_rss'] = "MWRss::modul_mw_rss";
// Az előfuttatási funkciók beállítása
// Az utófuttatási funkciók beállítása
Core::insert_postfunction("site_init","MWRss","after_site_init");
Core::insert_postfunction("core_set_content","MWRss","after_core_set_content");
// A CMS kiegészítése
...
if ((Core::$DEBUG_LEVEL > 3)&&(Core::$MODE == "DEBUG"))
{
	...
	Core::$TIMES .= sprintf("%-42s","mw_rss/init.inc:")
